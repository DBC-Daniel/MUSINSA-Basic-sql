...
# MAGIC 
# MAGIC   // Spark 2 uses "database" column and Spark 3 uses "namespace"
# MAGIC   val SPARK_SCALA_VERSION = sys.env("SPARK_SCALA_VERSION")
# MAGIC   val columnName = if (SPARK_SCALA_VERSION == "2.12") "namespace" else if (SPARK_SCALA_VERSION == "2.11") "databaseName" else "unknown"
# MAGIC   
# MAGIC   assert(spark.sql(s"SHOW DATABASES LIKE '$expectedDatabaseName'").first.getAs[String](columnName) == expectedDatabaseName)
...
# MAGIC 
# MAGIC   # Spark 2 uses "database" column and Spark 3 uses "namespace"
# MAGIC   SPARK_SCALA_VERSION = os.environ["SPARK_SCALA_VERSION"]
# MAGIC   if   SPARK_SCALA_VERSION == "2.12": columnName = "namespace"
# MAGIC   elif SPARK_SCALA_VERSION == "2.11": columnName = "databaseName"
# MAGIC   else: columnName = "unknown"
# MAGIC   
# MAGIC   assert spark.sql(f"SHOW DATABASES LIKE '{expectedDatabaseName}'").first()["namespace"] == expectedDatabaseName
